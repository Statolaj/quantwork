...
The current list of files include (and more added continuously):
  ...
  2) gaussian_moments.py which simulates the standard Gaussian moments using simple Monte Carlo. The files also contains improvements with a final version using anti-thetic variables for odd moments and the fact that squaring standard gaussian variable yields the $\chi^2$ distribution for even moments.
